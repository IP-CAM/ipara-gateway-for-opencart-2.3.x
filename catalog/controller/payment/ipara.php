...
class ControllerPaymentIpara extends Controller
{
	...
	public function index()
	{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/ipara.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/ipara.tpl', $data);
		} else {
			return $this->load->view('default/ipara.tpl', $data);
		}
	}
	...
	public function paymentform()
	{
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/ipara_ccform.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/ipara_ccform.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('payment/ipara_ccform.tpl', $data));
		}
	}
